...
/*        list.add(new String[]{"http://192.168.35.115/MyAppServer/photo2/img_cardIm01.jpg", "I’m WONDERFUL", "예쁜카드입니다."});
        ...
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm01.jpg", "I’m WONDERFUL", "예쁜카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm02.jpg", "I'm GREAT", "예쁜카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm03.jpg", "I'm CHEERFUL", "예쁜카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm04.jpg", "I'm HEARTFUL", "예쁜카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm05.jpg", "I'm JOYFUL", "예쁜카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo2/img_cardIm06.jpg", "I'm YOLO", "예쁜카드입니다."});
