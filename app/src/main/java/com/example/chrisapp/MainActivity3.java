...
/*        list.add(new String[]{"http://192.168.35.115/MyAppServer/photo3/card_deep_pc2.png","신한카드 Deep Dream Platinum+","훌륭한 카드입니다."});
        ...
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/card_deep_pc2.png","신한카드 Deep Dream Platinum+","훌륭한 카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/card_theace.png","신한카드 Deep Oil","훌륭한 카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/card_deepon.png","신한카드 Deep On Platinum+","훌륭한 카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/dream(96dpi)_1.png","신한카드 Deep Dream 체크","훌륭한 카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/card_malltail_pc01.png","몰테일 신한카드 체크","훌륭한 카드입니다."});
        list.add(new String[]{"http://192.168.0.56/MyAppServer/photo3/card(pc)_2.png","FANtastic S 신한카드 체크","훌륭한 카드입니다."});
